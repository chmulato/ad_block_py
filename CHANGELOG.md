...
**🛡️ Primeira versão estável do Bloqueador de Propagandas para Windows**

### ✨ Novas Funcionalidades

- **🚀 Executável Independente**: `AdBlocker.exe` (12.58 MB) - não precisa Python
- **🐍 Script Python**: `block.py` - código-fonte completo
- **⚙️ Instalador Automático**: `install_complete.bat` - configuração completa
...
**🎯 Resultado**: Navegação 95% livre de propagandas, mais rápida e segura! 🛡️